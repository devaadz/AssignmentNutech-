...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li aria-current="page" class="breadcrumb-item active">Edit Produk</li>
        </ol>
    </nav>
    <h4>Edit Produk</h4>
    ...
    <form action="{{ route('product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <input class="form-control @error('name') is-invalid @enderror" id="namaBarang" name="name" placeholder="Masukan nama barang" type="text" value="{{ old('name', $product->name) }}" />
                @error('name')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <input class="form-control @error('purchase_price') is-invalid @enderror" id="hargaBeli" name="purchase_price" type="text" placeholder="Masukan harga barang" value="{{ old('purchase_price', $product->purchase_price) }}" oninput="hitungHargaJual()" />
            ...
            <div class="col-md-6">
                ...
                <input class="form-control @error('sale_price') is-invalid @enderror" id="hargaJual" name="sale_price" type="text" placeholder="Harga Jual Barang" value="{{ old('sale_price', $product->sale_price) }}" readonly />
                @error('sale_price')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <input class="form-control @error('stock') is-invalid @enderror" id="stokBarang" name="stock" placeholder="Masukan jumlah stok barang" type="text" value="{{ old('stock', $product->stock) }}" />
                @error('stock')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
